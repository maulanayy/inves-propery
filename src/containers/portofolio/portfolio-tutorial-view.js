...
const View = (showTutorialPortfolio) => {
  return (
    
          <div className="main-dashboard portfolio-tutorial" style={{display: showTutorialPortfolio ? 'block' : 'none'}}>
            ...
            <div className="row">
              <div className="col-lg-11half">
                ...
                <div className="row ml-0">
                  <div className="col-lg-3 card-proyek-counter text-center mr-4 card-proyek-summary">
                    <div className="row">
                  ...
                  <div className="col-lg-3 card-list mr-4 card-proyek-aktif">
